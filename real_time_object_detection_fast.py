...
def sendData(className):
	try:
		urllib.request.urlopen("http://192.168.43.233:8000/sendClass?class={}".format(className))
	except:				
		print("")
...
#vs = VideoStream(src=1,resolution=(640,480),framerate=500).start()
...
while True:
	...
	for i in np.arange(0, detections.shape[2]):
		...
		if confidence > 0.75:
			...
			#t1 = threading.Thread(target=sendData,args=(CLASSES[idx],))
			#t1.start()
